...
(setq load-path (append load-path '("~/my-lisps/cedet-1.0/elib")))
...
(defconst user-include-dirs
  (list ".." "../include" "../inc" "../common" "../public"
        ...
        "../header"))
(defconst gtk+-include-dirs
  (list "e:/LikeUnix/gtk+/include"
        "e:/LikeUnix/gtk+/include/gtk-2.0"
        "e:/LikeUnix/gtk+/include/glib-2.0"
        ))

(require 'semantic-c nil 'noerror)
(require 'semantic-cpp nil 'noerror)
(let ((include-dirs user-include-dirs))
  ;; (when (eq system-type 'windows-nt)
  ;;   (setq include-dirs (append include-dirs win32-include-dirs)))
    (setq include-dirs (append include-dirs gtk+-include-dirs))
  (mapc (lambda (dir)
...
(setq linux-project
     (ede-cpp-root-project "linux" :file "E:/Codes/C/linux_ch_comment/Makefile"
                           :include-path '(
                                           "E:/Codes/C/linux_ch_comment/inckude/asm"
                                           "E:/Codes/C/linux_ch_comment/inckude/linux"
                                           "E:/Codes/C/linux_ch_comment/inckude/sys"
                                           )))

(setq eps-project
     (ede-cpp-root-project "EPS" :file "E:/svn/EPSSRC/SourceAssimilate/Branch/assimilateMain_JP/polygraph.mak"
                           :include-path '(
                                           "E:/svn/EPSSRC/SourceAssimilate/Branch/assimilateMain_JP/PolyCommLib/"
                                           "E:/svn/EPSSRC/SourceAssimilate/Branch/assimilateMain_JP/PolyWaveDraw/DirectX/header/"
                                           "e:/svn/EPSSRC/SourceAssimilate/Branch/assimilateMain_JP/PolyWaveDraw/Common/header/"
                                           "E:/svn/EPSSRC/SourceAssimilate/Branch/assimilateMain_JP/PolyWaveDraw/Draw/header/"
                                           )))
