...
(defconst win32-include-dirs
  (list "/mingw/lib/gcc/mingw32/4.5.0/include"
        "/mingw/lib/gcc/mingw32/4.5.0/include/c++"
        "/mingw/include"   
...
(setq semanticdb-project-roots 
    (list 
         (expand-file-name "E:/mingw/include/")
         (expand-file-name "/include/")
         (expand-file-name "/mingw/include/")
         (expand-file-name "./")
         (expand-file-name "../")
         (expand-file-name "../include")
         ...
         (expand-file-name "../../public")
;; GTK include
         (expand-file-name "/GTK+/include")
         (expand-file-name "../../public")
         (expand-file-name "../../public")
;;         (expand-file-name "E:/Program Files/Microsoft Visual Studio/VC98/MFC/Include")
))
